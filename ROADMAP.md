...
Stages 0-21 are implemented and documented. Stage 21 published the first
public alpha tag `v0.1.0-alpha` after current-main validation, reviewed SYNOP
identifier reconciliation, and the 2026-07-20 automated pre-tag suite. Stages
22-26 remain planned only.
...
- Stage 21 - Current-main production validation and `v0.1.0-alpha` release
  (done): local and production smoke tests, fresh and upgraded volumes,
  screenshots, release notes, rollback, backup/restore, and abuse checks are
  recorded in `docs/release/STAGE_21_VALIDATION_2026-07-14.md`. Reviewed SYNOP
  live/archive identifier reconciliation and the 2026-07-20 automated pre-tag
  suite cleared the remaining gates; `v0.1.0-alpha` is tagged and published as
  a GitHub prerelease.
